...
<script
	src="http://kendo.cdn.telerik.com/2016.1.412/js/kendo.all.min.js"></script>
<script src="http://code.jquery.com/jquery-1.9.1.min.js"></script>
<script
	src="http://kendo.cdn.telerik.com/2016.1.412/js/kendo.all.min.js"></script>
		...
		<div class="row" style="margin-top: 3%;">
			<div class="col-md-4" >
				<div class="panel panel-default" style="height: 800px; border: solid silver 3px;">
					...
					<div class="mytree">
					<img  src="resources/img/tree.png" alt="logo"
							...
							.kendoChart(
									{
										categoryAxis : [ {
											...
											categories : [ "SPM", "AHE", "PPI",
													"OET", "PPI", "IM", "AHE",
													"Other" ]
										} ],
										series : [ {
											data : [ 31.7, 18.4, 11.2, 8.8,
													8.6, 8.2, 7.7, 5.5 ]
										} ]
									});
				</script>
