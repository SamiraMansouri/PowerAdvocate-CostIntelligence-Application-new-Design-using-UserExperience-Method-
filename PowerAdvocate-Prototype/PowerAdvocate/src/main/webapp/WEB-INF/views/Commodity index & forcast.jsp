			...
			<div class="col-md-8">
				...
				<!-- description -->
					...
					<img src="resources/img/PriceForcast-chart.png" class="img-rounded"
						alt="Chania" width="100%" height="30%" style="margin-top: 10%">
				</div>
				<!-- chart -->
				<div class="panel panel-default choices">
					<table>
						<tr>
							<td><label style="margin-right: 10%;">Start term: </label></td>
							<td>
								<div class="dropdown">
							...
							<td width="10%"></td>
							<td><label style="margin-right: 3%; margin-left: 70%;">End
									term:</label></td>
					...
					<div class="panel panel-default"
						style="border-radius: 0; margin-top: 3%; margin-right:3%;">
						<div class="panel-body" style="  overflow-y:scroll; height:100%; ">
							<table>
								<tr>
								<td>
									<label><input type="checkbox"> AHE: Foundries (+14.725%)</label>
										</td>
										</tr>
								<tr>
									<td>
									<label><input type="checkbox">AHE: Iron & Steel Mills (+26.621%)</label>
									</td>
								</tr>
									<tr>
									<td>
									<label><input type="checkbox">ECI: Compression, Private, Professional, Scientific, technical (+59.850%)</label>
									</td>
								</tr>
								
									<tr>
									<td>
									<label><input type="checkbox"> IM: 24" Dia Line Pipe, Overhead (+14.752%)</label>
									</td>
								</tr>
								<tr>
								<td>
								 <label><input type="checkbox"> OET: 24" Dia Line Pipe, Margin (+59.850%)</label>
								</td></tr>
							</table>
