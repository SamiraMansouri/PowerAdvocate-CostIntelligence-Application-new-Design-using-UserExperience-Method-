...
<div class="container">
	...
	<div class="row">
		<ul class="nav nav-tabs">
  			<li role="presentation"><a href="#"><b>Spend Intelligence</b></a></li>
  			<li role="presentation" class="active"><a href="#">Cost Intelligence</a></li>
  			<li role="presentation"><a href="#"><b>Market Intelligence</b></a></li>
  			<li role="presentation"><a href="#"><b>Sourcing Intelligence</b></a></li>
  			<li role="presentation"><a href="#"><b>Contract Intelligence</b></a></li>
  			<li role="presentation"><a href="#"><b>Supplier Intelligence</b></a></li>
		</ul>
	</div><!--end of row-->
	<div class="row">
   ...
   <div class="row"> 
    ...
    <div class="row top-buffer ">
    	...
    	<div class="col-md-8">
				...
				<button type="Button" class="btn btn-warning">Power Advocate Model</button>
				<button type="Button" class="btn btn-warning">My Company's Model</button>
