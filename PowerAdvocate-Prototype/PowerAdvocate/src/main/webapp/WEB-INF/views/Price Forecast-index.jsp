		...
		<div class="row" style="margin-top: 3%;">
			<div class="col-md-4"
				...
				<div class="panel panel-default" style="height: 800px; border: solid silver 3px;">
					...
					<div>
						<button type="button" class="btn btn-link commonLinks" id="myBtn"
					...
					<div class="row" style="margin-top: 50px; margin-bottom: 50px;">
						...
						<div class="col-md-8 " id="tree1" style="padding-left: 0;"></div>
						<div class="col-md-2"></div>
					</div>
				</div>
			...
			<div class="col-md-8">
				...
				<div>
					<label class="radio-inline"> <input type="radio"
						name="optradio" checked="true">Index
					</label> <label class="radio-inline"> <input type="radio"
						onclick="window.open('/prototype/PriceForecastShouldCostgraph')"
						name="optradio">Should-cost gragh
					</label>
				</div>
				<!-- radiobuttons -->
				<div style="margin-top: 5%" class="pull-right">
					<a href="www.google.com"><b>Compare Model Indices</b></a>
				</div>
				<div>
					<img src="resources/img/PriceForcast-chart.png" class="img-rounded"
						alt="Chania" width="100%" height="30%"
						style="margin-top: 1%; margin-bottom: 30%;">
		...
		<div class="footer">
			<div class="row ">
				...
				<div class="col-md-6" id="col2">
					<ul>
						<li><a href="#"> PowerAdvocate Technical Support:<b>
									(857) 453-5800</b></a></li>
						<li><a href="#"> PowerAdvocate Corporate: <b>(857)
									453-5700 </b></a></li>
						<li><a href="#"><b>support@powerdadvocate.com</b> </a></li>
					</ul>
				</div>
			</div>
			<div class="row">
