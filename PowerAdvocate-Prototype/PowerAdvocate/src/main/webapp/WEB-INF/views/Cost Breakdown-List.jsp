...
<html lang="en">
<head>
<title>Cost Breakdown List</title>
<meta charset="utf-8">
		...
		<div class="row">
			<div class=" collapse navbar-collapse "
				...
				<ul class="nav navbar-nav">
					...
					<li><a href="#"></a></li>
					<li><a href="#"></a></li>
					<li><a href="/prototype/PriceForecastIndex">Index and
							forcast</a></li>
					<li><a href="#"></a></li>
			...
			<div class="col-md-8">
				...
				<div>
					<label class="radio-inline"> <input type="radio"
						...
						name="optradio" checked="true">List
					</label>
				</div>
				<!-- radiobuttons -->
				<div>
					<img src="resources/img/ListPic.png" class="img-rounded"
		...
		<div class="footer top-buffer">
			<div class="row ">
				...
				<div class="col-md-6" id="col2">
					<ul>
						<li><a src="#"> PowerAdvocate Technical Support: (857)
								453-5800</a></li>
