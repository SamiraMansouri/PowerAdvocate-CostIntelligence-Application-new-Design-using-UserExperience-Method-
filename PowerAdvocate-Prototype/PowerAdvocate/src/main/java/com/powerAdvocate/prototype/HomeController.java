...
public class HomeController {
	...
	public String secondPageDocuments(Locale locale, Model model) {
	...
	@RequestMapping(value = "/CommodityIndexAndForecast", method = RequestMethod.GET)
	public String secondPageCommodityIndexAndForecast(Locale locale, Model model) {
